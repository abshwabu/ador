...
class ProjectSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $projects = [
            ...
            [
                'title' => 'Adorn Flagship Showroom & Material Hub',
                'slug' => 'adorn-flagship-showroom',
                'client' => 'Adorn Trading PLC',
                ...
                'cover_image' => 'projects/adorn-showroom-cover.jpg',
                'sort_order' => 5,
                'is_active' => true,
                'featured' => true,
                'images' => [
                    ['image_path' => 'projects/adorn-showroom-1.jpg', 'caption' => 'Main showroom kitchen display with premium stone countertops', 'sort_order' => 1],
                    ['image_path' => 'projects/adorn-showroom-2.jpg', 'caption' => 'Material sample library and consultation lounge', 'sort_order' => 2],
                    ['image_path' => 'projects/adorn-showroom-3.jpg', 'caption' => 'Architectural aluminium systems and hardware display', 'sort_order' => 3],
                ],
            ],
        ];
